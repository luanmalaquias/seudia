...
var negativePhrases = [
    ...
    "Acreditar que você pode ja é meio caminho errado.",
    "Pare de desejar e comece a desistir.",
    "Procrastinar é acreditar no potencial do seu eu do amanhã.",
    "O não você ja tem, só falta buscar a humilhação.",
    ...
    "Pare de achar que ningém gosta de você, tenha certeza disso.",
    ...
    "Elx não é dificil, você que é feix.",
    ...
    "Para de tentar criar polêmica para chamar atenção. Todo mundo te acha um bxsta.",
    ...
    "Ta todo mundo trxnsando menos você.",
    "Nasceu para ser feito de otárix.",
    "Agradeça seu pai por ele te amar mesmo você sendo um mxrda.",
    "Comer que nem um filho da pxta não vai esconder o fracasso da sua vida.",
...
var positivePhrases = [
    ...
    "Depois do sacrificio vem a vitória.",
    "Sorria.",
    ...
    "Você nasceu para ser o amor de algúem.",
